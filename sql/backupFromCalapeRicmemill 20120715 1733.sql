...
INSERT INTO `expenses` (`id`,`description`,`amount`,`date_created`) VALUES 
 (1,'Milling Charge',100,'2012-07-15');
...
CREATE TABLE `partida` (
  ...
  `stockout_status` int(11) DEFAULT NULL,
...
INSERT INTO `partida` (`id`,`name`,`status`,`stockout_status`,`created_at`,`created_by`) VALUES 
 (1,'Partida 1 ','1',0,'2012-07-15','admin'),
 (2,'Partida 2 ','1',0,'2012-07-15','admin'),
 (3,'Partida Sample','1',0,'2012-07-15','admin'),
 (4,'Partida 3 ','1',0,'2012-07-15','admin');
...
INSERT INTO `stock_in` (`id`,`item_id`,`qty_in`,`price`,`total_amount`,`description`,`date_in`,`received_by`) VALUES 
 (1,1,1000.00,26.00,26000.00,'Humay Pula','2012-07-15 00:00:00','admin'),
 (2,1,150.00,25.00,3750.00,'Humay Puti','2012-07-15 00:00:00','admin'),
 (3,1,500.00,25.00,12500.00,'Humay Puti','2012-07-15 00:00:00','admin'),
 (4,1,300.00,28.00,8400.00,'Humay','2012-07-15 00:00:00','admin');
...
INSERT INTO `stock_out` (`id`,`item_id`,`qty_out`,`price`,`total_amount`,`date_out`,`out_by`) VALUES 
 (1,1,1.00,1500.00,1500.00,'2012-07-15','admin');
